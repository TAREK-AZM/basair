...
const rulesData = [
  ...
  },
  {
    ...
    content:
      "يجب إدارة الشؤون المالية للنادي بشفافية ومسؤولية. سيتم استخدام الأموال حصريًا لأنشطة النادي وللضروريات المتعلقة بصيانة مكان الصلاة ولمبادرات الخيرية. المكتب التنفيذي هو المسؤول عن إدارة الشؤون المالية للنادي ومتابعتها.",
  },
];
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              ...
              يهدف هذا النظام الداخلي إلى تنظيم عمل نادي بصائر وضمان بيئة
              إيجابية ومثمرة لجميع الأعضاء. نؤكد على أهمية الالتزام بمبادئ
              الحيادية، والاعتدال، والوسطية، والتعاون البنّاء بين جميع الأعضاء.

              يتناول النظام الداخلي بنوداً أساسية مثل سلوك الأعضاء، وتشكيل
              النادي، وإدارة موارده، بهدف ضمان الشفافية، والمساءلة، وتحقيق
              أهداف النادي على أكمل وجه.

              ندعو جميع الأعضاء إلى التعرف على بنود هذا النظام والتعاون على
              تطبيقه بما يحقق مصلحة نادي بصائر ويضمن تقدمه وازدهاره.
            </p>
          </div>

          {/* Dynamic Collapsible Components */}
          {rulesData.map((rule, index) => (
            <CollapsibleItem key={index} title={rule.title} content={rule.content} />
          ))}
